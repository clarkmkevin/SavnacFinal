...
<div class="navbar">
  <a href='?goHome()'   class="active">Home</a>
 ...
 ?> 
    ...
    <a href="../messages/social_media/messages.php"><input type="submit" name="Ask a Question!" id="create" value="Ask a Question!"></a>
